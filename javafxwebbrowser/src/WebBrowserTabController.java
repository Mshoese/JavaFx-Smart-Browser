...
public class WebBrowserTabController extends StackPane {
	...
	private void initialize() {
		...
		searchEngineComboBox.getItems().addAll("Bing", "Baidu", "Google", "Yahoo");
		...
		about.setOnAction(a -> {
			...
			alert.setTitle("SecAdapt Browser");
	...
	public String getSearchEngineHomeUrl(String searchProvider) {
		...
		switch (searchProvider.toLowerCase()) {
			...
			default: //then nottingham
				return "https://www.nottingham.edu.cn/en/index.aspx";
		}
	}
	...
	void checkForInternetConnection() {
		...
		Thread thread = new Thread(() -> {
			boolean hasInternet = InfoTool.isReachableByPing("www.bing.com");
			Platform.runLater(() -> {
