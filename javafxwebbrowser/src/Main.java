...
//import javafxwebbrowser.WebBrowserController;
//import javafxwebbrowser.InfoTool;
...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		//Prepare the Stage
		primaryStage.setTitle("SecAdapt Browser");
		primaryStage.getIcons().add(InfoTool.getImageFromResourcesFolder("logo1.png"));
